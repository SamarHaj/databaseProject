...
public class SalesOrder extends JFrame {
	...
	public SalesOrder() {
		...
		btnNewButton_4.setBounds(0, 231, 168, 45);
		...
		JButton btnNewButton_2 = new JButton("Edit Selected Order");
		...
		JButton btnNewButton_3 = new JButton("Remove Selected Order");
		btnNewButton_3.setBounds(577, 116, 90, 28);
		panel_1.add(btnNewButton_3);
		
		JButton btnShowFenancialStatus = new JButton("Show Fanancial Status For Selected Customer");
		btnShowFenancialStatus.setBounds(577, 150, 90, 28);
		panel_1.add(btnShowFenancialStatus);
		...
		JButton button = new JButton("Remove Selected Order");
		button.setBounds(578, 111, 90, 28);
		panel_2.add(button);
		
		JButton button_1 = new JButton("Edit Selected Order");
		button_1.setBounds(578, 71, 90, 28);
		...
		JButton button_2 = new JButton("Remove Selected Order");
		button_2.setBounds(575, 108, 90, 28);
		panel_3.add(button_2);
		
		JButton button_3 = new JButton("Edit Selected Order");
		button_3.setBounds(575, 68, 90, 28);
		panel_3.add(button_3);
		
		JLabel lblNewLabel = new JLabel("Sales Orders");
		lblNewLabel.setBounds(222, 43, 183, 38);
		contentPane.add(lblNewLabel);
		
		JButton btnNewButton_1 = new JButton("+ New Sales Order");
